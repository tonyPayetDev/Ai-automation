...
const AutomationBoost: React.FC<AutomationBoostProps> = ({ config }) => {
  ...
  return (
    <section id="boost" className="py-24 md:py-32 relative overflow-hidden bg-[#050505] scroll-mt-20">
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#f05a28]/20 to-transparent"></div>
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#f05a28]/[0.04] blur-[150px] pointer-events-none rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#f05a28]/40 bg-[#f05a28]/8 text-[#f05a28] text-xs font-medium tracking-widest uppercase mb-6"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-7 space-y-8">
            ...
            <motion.div 
              ...
              className="bg-[#0a0a0a] border border-white/5 border-l-2 border-l-[#f05a28]/50 p-8 rounded-2xl"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                {config.solution1.items.map((item, i) => (
                  <div key={i} className="flex items-center gap-2 text-gray-400">
                    <div className="w-1 h-1 bg-[#f05a28] rounded-full"></div>
                    {item}
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-5">
            <motion.div 
              ...
              className="relative p-6 md:p-10 bg-[#0d0d0d] border border-[#f05a28]/30 rounded-2xl shadow-[0_0_40px_rgba(184,150,90,0.08)] overflow-hidden sticky top-24"
            >
              <div className="absolute top-0 right-0 p-4 opacity-10">
                <Rocket size={120} />
              </div>
              <h4 className="text-[#f05a28] text-lg font-medium tracking-widest mb-2 uppercase" style={{ fontFamily: "'Plus Jakarta Sans', serif" }}>Boost 48H</h4>
              <div className="mb-6">
                <div className="flex items-center gap-2 mb-1">
                   <span className="text-xl text-gray-500 line-through font-mono">{config.pricing.originalPrice}</span>
                   <span className="text-[10px] bg-[#f05a28] text-black px-1.5 py-0.5 font-bold rounded uppercase tracking-tighter">{config.pricing.label}</span>
                </div>
              ...
              <div className="space-y-6 mb-10">
                <div className="flex items-center gap-3 text-white font-bold">
                  <Clock className="text-[#f05a28] w-5 h-5" />
              ...
              <div className="flex flex-col gap-4">
                <button
                  ...
                  className="w-full py-4 bg-[#f05a28] text-[#050505] font-medium uppercase tracking-widest rounded hover:bg-[#ff6b3d] transition-all transform hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(184,150,90,0.2)]"
                >
        ...
        {isModalOpen && (
          ...
          >
            <motion.div 
              ...
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.9, y: 20 }}
              className="relative w-full max-w-3xl my-8 bg-black border border-[#f05a28]/30 rounded-lg shadow-[0_0_50px_rgba(234,179,8,0.1)] overflow-hidden"
              style={{ clipPath: 'polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)' }}
            >
              <div className="absolute top-0 left-0 w-full h-1 bg-[#f05a28]"></div>
              ...
              <div className="p-6 md:p-10">
                ...
                {isSuccess ? (
                  ...
                  >
                    <div className="w-16 h-16 bg-[#f05a28]/20 border border-[#f05a28]/50 rounded-full flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(234,179,8,0.3)]">
                      <Lightbulb className="text-[#f05a28] w-8 h-8" />
                    </div>
                    ...
                    {aiProposal ? (
                      <div className="w-full space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="p-4 bg-zinc-900/80 border border-white/10 rounded-lg">
                            ...
                            <div className="flex items-end gap-2">
                                <span className="text-2xl sm:text-4xl font-black text-[#f05a28]">{aiProposal.score}%</span>
                                <div className="flex-1 h-2 bg-zinc-800 rounded-full mb-2 overflow-hidden">
                                    <motion.div initial={{ width: 0 }} animate={{ width: `${aiProposal.score}%` }} className="h-full bg-[#f05a28]" />
                                </div>
                            </div>
                          </div>
                          <div className="p-4 bg-zinc-900/80 border border-white/10 rounded-lg">
                        ...
                        <div className="p-6 bg-[#f05a28]/5 border border-[#f05a28]/20 rounded-lg space-y-4">
                          <div>
                            <h5 className="text-[#f05a28] text-xs font-mono uppercase flex items-center gap-2 mb-2">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <input required type="text" placeholder="Nom Prénom" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 pl-10 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani" />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <input required type="email" placeholder="email@pro.com" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 pl-10 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani" />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <input required type="tel" placeholder="06 XX XX XX XX" value={formData.phone} onChange={e => setFormData({...formData, phone: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 pl-10 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani" />
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        ...
                        <div className="relative">
                          ...
                          <input required type="url" placeholder="https://..." value={formData.website} onChange={e => setFormData({...formData, website: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 pl-10 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-6 border-t border-white/5 space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <select value={formData.businessType} onChange={e => setFormData({...formData, businessType: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani appearance-none">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <div className="relative">
                            ...
                            <select value={formData.teamSize} onChange={e => setFormData({...formData, teamSize: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 pl-10 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani appearance-none">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <select value={formData.revenue} onChange={e => setFormData({...formData, revenue: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani appearance-none">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input required type="text" placeholder="Ex: Saisie manuelle de commandes, Gestion client..." value={formData.bottleneck} onChange={e => setFormData({...formData, bottleneck: e.target.value})} className="w-full bg-zinc-900/50 border border-white/10 rounded p-3 text-white text-sm focus:border-[#f05a28]/50 outline-none font-rajdhani" />
                      </div>

                      <div className="space-y-3">
                         <div className="flex justify-between items-center">
                            <label className="text-[10px] text-gray-500 font-mono uppercase">Time_Waste (hours/week)</label>
                            <span className="text-[#f05a28] font-bold font-mono text-sm">{formData.hoursLost}h</span>
                         </div>
                         <input type="range" min="1" max="60" step="1" value={formData.hoursLost} onChange={e => setFormData({...formData, hoursLost: e.target.value})} className="w-full h-1.5 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-[#f05a28]" />
                      </div>
                    </div>
                    ...
                    <div className="pt-4">
                      <button 
                        ...
                        className="w-full py-4 bg-[#f05a28] text-black font-black uppercase tracking-widest rounded hover:bg-[#ff6b3d] transition-all transform active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50 shadow-[0_0_20px_rgba(234,179,8,0.3)]"
                      >
                        {isSubmitting ? (
                          <>
