...
const Hero: React.FC<HeroProps> = ({ media }) => (
  ...
  >
    {/* Fond animé : particules néon + visage en pointillés (subtil) */}
    <HeroBackground />
      ...
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        >
          <div className="relative">
            ...
            {/* Portrait */}
            <div className="relative w-60 h-72 sm:w-72 sm:h-88 lg:w-88 lg:h-[440px] rounded-2xl overflow-hidden bg-[#0C0D18]">
              {/* Le clip de Tony, en boucle, son coupé tant qu'on ne le demande pas */}
              <HeroVideo src="videos/hero-tony-2508.mp4" poster="videos/hero-tony-2508-poster.jpg" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C0D18]/70 via-transparent to-transparent pointer-events-none" />
            ...
            <motion.div
              ...
              className="hidden sm:block absolute -bottom-8 -left-10 bg-[#171726] border border-white/8 rounded-2xl p-4 shadow-2xl z-20"
            >
              <p className="text-2xl font-bold text-white leading-none">
                15h <span className="text-[#3DC4C2] text-sm font-medium">rattrapées</span>
              </p>
              <p className="text-[#4E7080] text-xs tracking-wide mt-1.5">chaque semaine</p>
            </motion.div>
